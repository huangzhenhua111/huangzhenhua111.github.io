"""
Prompt templates for MultiAgentESC reproduction on MASFactory.
Strictly aligned with source: https://github.com/MindIntLab-HFUT/MultiAgentESC/prompt.py + multiagent.py
"""

prompts = {
    # ===== From source prompt.py =====
